...
<html lang="en">
<head>
<title>Prepare Work Zone Traffic Management Plan Course Calendar | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Prepare Work Zone Traffic Management Plan Course Calendar</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>																		<li><a href="<?php echo $url; ?>prepare-work-zone-traffic-management-plan-course">Prepare Work Zone Traffic Management Plan Course Course</a></li>
									<li>Prepare Work Zone Traffic Management Plan Course Calendar</li>
								</ul>
							</div>
						</div>
					</div>
	...
	<div class="calendar-wrap">
		<div class="container">
			...
			<div class="marquee-wrap">
				...
				<iframe style="width: 100%; border: 0px; outline: 0px; padding: 0px; margin: 0px; height: 1660px;" data-src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&courseId=4292257591920640&campusId=null&parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" class=" lazyloaded" src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&courseId=4292257591920640&campusId=null&parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" loading="lazy"></iframe>
				</div>
