...
<html lang="en">
<head>
<title>Liverpool Training Facility Sydney | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Liverpool Training Facility</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>
									<li><a href="<?php echo $url; ?>calendar">Calander</a></li>
									<li>Liverpool Training Facility</li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="row about_row row-lg-eq-height">
				<div class="col-lg-6">
					<div class="about_content">
						<div class="about_title">Liverpool Training Facility</div>
						<div class="about_text">
							<p>Trans-Plant Training offers accredited <a herf="<?php echo $url; ?>traffic-controller-course">traffic control training</a>, and <a href="<?php echo $url; ?>white-card">white card courses</a> from it’s training location in Liverpool, NSW.</p>
<p>
These courses offer students the ability to gain a SafeWork NSW Traffic Control Work Training Card which is commonly completed for employment within the traffic management industry or a White Card which is required for workers who want to carry out work on a construction site. </p>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="location_body text-center">
							<h2>Address</h2>
							<p style="text-align: center;">Suite 2, Level 2/224-238 George St, Liverpool NSW 2170, Australia</p>
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3310.6912038188793!2d150.92279581521166!3d-33.92334628064126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b1295d5480c2377%3A0xae333c5b915eef93!2sTrans-Plant%20Training%20-%20Liverpool!5e0!3m2!1sen!2sin!4v1652273286331!5m2!1sen!2sin" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						</div>
				</div>
			</div>
	...
	<div class="calendar-wrap">
		<div class="container">
			<div class="">
				<div name="COURSE_LIST" data-org="2126265328226235" data-campus="4482002036769792
" data-host="booking.trans-planttraining.com.au">
<iframe data-lazyloaded="1" src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&amp;courseId=null&amp;campusId=4482002036769792
&amp;parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" data-src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&amp;courseId=null&amp;campusId=4482002036769792
&amp;parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" style="width: 100%; border: 0px; outline: 0px; padding: 0px; margin: 0px; height: 825px;" class="litespeed-loaded" data-was-processed="true"></iframe>
</div>
<hr />
