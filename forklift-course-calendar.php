					...
					<div class="col">
						<div class="home_content text-center">
							...
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>																		<li><a href="<?php echo $url; ?>all-courses">Courses</a></li>																		<li><a href="<?php echo $url; ?>forklift-course">Forklift Course</a></li>
									<li>Forklift Course Calendar</li>
								</ul>
							</div>
						</div>
					</div>
