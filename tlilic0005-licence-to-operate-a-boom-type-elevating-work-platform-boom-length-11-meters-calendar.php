...
<html lang="en">
<head>
<title>TLILIC0005 Licence to operate a boom-type elevating work platform (Boom Length 11 meters or more) Calendar | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">TLILIC0005 Licence to operate a boom-type elevating work platform (Boom Length 11 meters or more) Calendar</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>																		<li><a href="<?php echo $url; ?>all-courses">Courses</a></li>																		<li><a href="<?php echo $url; ?>childcare-first-aid-course">TLILIC0005 Licence to operate a boom-type elevating work platform (Boom Length 11 meters or more)</a></li>
									<li>TLILIC0005 Licence to operate a boom-type elevating work platform (Boom Length 11 meters or more) Calendar</li>
								</ul>
							</div>
						</div>
					</div>
