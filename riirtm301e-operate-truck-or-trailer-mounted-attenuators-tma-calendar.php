...
<html lang="en">
<head>
<title>RIIRTM301E Operate truck or trailer mounted attenuators Calendar | Trans-Plant training</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<div class="home breadcrumb-banner">
		...
		<div class="home_background parallax_background parallax-window hidden-xs" data-parallax="scroll" data-image-src="<?php echo $url; ?>images/calendar-desk2.jpg" data-speed="0.8"></div>
		<div class="home_background parallax_background parallax-window hidden-xl hidden-lg hidden-sm hidden-md" data-parallax="scroll" data-image-src="<?php echo $url; ?>images/calendar-mob2.jpg" data-speed="0.8"></div>
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">RIIRTM301E Operate truck or trailer mounted attenuators Calendar</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>																		<li><a href="<?php echo $url; ?>all-courses">Courses</a></li>																		<li><a href="<?php echo $url; ?>riirtm301e-operate-truck-or-trailer-mounted-attenuators-tma">RIIRTM301E Operate truck or trailer mounted attenuators</a></li>
									<li>RIIRTM301E Operate truck or trailer mounted attenuators Calendar</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="marquee-wrap">
				<marquee direction="right" behavior="alternate"> 
					<p>Click on Available date for Booking</p>
				</marquee>
			</div>
				<div name="COURSE_LIST" data-org="2126265328226235" data-campus="" data-host="booking.trans-planttraining.com.au">
				<iframe style="width: 100%; border: 0px; outline: 0px; padding: 0px; margin: 0px; height: 1660px;" data-src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&courseId=4292258176075776&campusId=null&parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" class=" lazyloaded" src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&courseId=4292258176075776&campusId=null&parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" loading="lazy"></iframe>
				</div>
