				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Provide Responsible Gambling Services (RCG) Course Calendar</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>																		<li><a href="<?php echo $url; ?>all-courses">Courses</a></li>																		<li><a href="<?php echo $url; ?>rcg-course">Provide Responsible Gambling Services (RCG) Course</a></li>
									<li>Provide Responsible Gambling Services (RCG) Course Calendar</li>
								</ul>
							</div>
						</div>
					</div>
	...
	<div class="calendar-wrap">
		<div class="container">
			...
			<div class="marquee-wrap">
				...
				<iframe style="width: 100%; border: 0px; outline: 0px; padding: 0px; margin: 0px; height: 1660px;" data-src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&courseId=4280977948444672&campusId=null&parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" class=" lazyloaded" src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&courseId=4280977948444672&campusId=null&parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" loading="lazy"></iframe>
				</div>
