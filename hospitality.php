...
<html lang="en">
<head>
<title>Hospitality Sydney | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Hospitality Courses</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>
									<li>Hospitality Courses</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="course" id="hopitality">
									...
									<div class="course_body">
										<div class="course_header d-flex flex-row align-items-center justify-content-start">
											<div class="course_tag"><a href="#">Hopitality</a></div>
										</div>
										<div class="mt-20 d-flex align-items-center justify-content-start">
											...
											<div class="course_price ml-auto">Price: <del></del> <span>$200</span></div>
										</div>
