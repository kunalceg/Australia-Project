...
<html lang="en">
<head>
<title>Penrith Training Facility Sydney | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Penrith Training Facility</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>
									<li><a href="<?php echo $url; ?>calendar">Calander</a></li>
									<li>Penrith Training Facility</li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="row about_row row-lg-eq-height">
				<div class="col-lg-6">
					<div class="about_content">
						<div class="about_title">Penrith Training Facility</div>
						<div class="about_text">
							<p>Trans-Plant Training offers accredited <a herf="<?php echo $url; ?>traffic-controller-course">traffic control training</a>, and <a href="<?php echo $url; ?>white-card">white card courses</a> from it’s training location in Penrith, NSW.</p>
				...
				<div class="col-lg-6">
					<div class="location_body text-center">
							...
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3317.2697126932435!2d150.6941202152073!3d-33.753695580688145!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12842ad3ecda3b%3A0x4279e017f43880b!2sTrans-Plant%20Training%20Pty%20Ltd!5e0!3m2!1sen!2sin!4v1652273631118!5m2!1sen!2sin" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						</div>
				</div>
			</div>
...
" data-host="booking.trans-planttraining.com.au"><iframe data-lazyloaded="1" src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&amp;courseId=null&amp;campusId=4280991129699328
&amp;parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" data-src="https://booking.trans-planttraining.com.au/course/list?orgId=2126265328226235&amp;courseId=null&amp;campusId=4280991129699328
&amp;parentUrl=https%3A%2F%2Ftrans-planttraining.com.au" style="width: 100%; border: 0px; outline: 0px; padding: 0px; margin: 0px; height: 1855px;" class="litespeed-loaded" data-was-processed="true"></iframe></div>
<hr />
