...
<html lang="en">
<head>
<title>Forklift Course Calendar Sydney | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Forklift Course Calendar</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>																		<li><a href="<?php echo $url; ?>all-courses">Courses</a></li>																		<li><a href="<?php echo $url; ?>riimpo320f-conduct-civil-construction-excavator-operations">Conduct civil construction excavator operations</a></li>
									<li>Conduct civil construction excavator operations Calendar</li>
								</ul>
							</div>
						</div>
					</div>
