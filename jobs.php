...
<html lang="en">
<head>
<title>Jobs | Trans-Plant training</title>
<meta charset="utf-8">
			...
			<div class="row about_row row-lg-eq-height">
				<div class="col-lg-6">
					<div class="about_content">
						...
						<div class="contact_text">
							<p><p>If you are looking for Construction, Traffic control or RSA-RCG related jobs , register your interest here. You'll be provided with login details to see available jobs from our job partners in related industries.
				...
				<div class="col-xl-6">
					<div class="contact_form_container">
							<form action="db.php" id="contact_form" class="contact_form" method="post">
								<div>
									<div class="row">
										<div class="col-lg-6 contact_name_col">
											<input type="text" class="contact_input" placeholder="User Name" name="cname" id="cname" maxlength="120" tabindex="1" /><br>
										</div>
										<div class="col-lg-6">
								...
								<div><input type="text" class="contact_input" placeholder="Mobile" name="cno" id="cno" maxlength="10" tabindex="4" /></div><br>
								<div><label for="">Upload Application for employment details</label> 
								     <input type="file" class="careers-file-upload" name="file" id="file" maxlength="10kb" tabindex="5" /></div><br>
								<div><textarea class="contact_input contact_textarea" placeholder="Message" name="cmsg" id="cmsg" tabindex="6"></textarea></div><br>
                                <div>
									<div class="row">
										<div class="col-lg-6 contact_name_col" align="left">
											<img src="captcha.php" />
										</div><br>
										<div class="col-lg-6">
											<input type="text" class="contact_input" placeholder="Security code" id="scode" name="scode" maxlength="6" tabindex="7"/>
										</div><br>
									</div>
								</div>
								<br><button type="text" class="contact_button" id="btnsubmit" tabindex="6"><span id="btn-container">Submit</span><span class="button_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button><br>
							<br>
							</form>
							<br>
						</div>
