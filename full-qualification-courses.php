...
<html lang="en">
<head>
<title>Full Qualification Courses Sydney | Trans-Plant training</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="Keywords" content="Trans-Plant training project, Full Qualification Courses, Full Qualification Courses Sydney"><meta name="description" content="If you are looking for how to join a Full Qualification Courses Sydney in Sydney, you are at the right place, visit our website or call us to make bookings">
...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Full Qualification Courses</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>
									<li>Full Qualification Courses</li>
								</ul>
							</div>
						</div>
					</div>
	...
	<div class="courses">
		<div class="container">
			...
			<!-- Course Search -->
						<!-- Course Search -->									<div class="row">					<div class="col-lg-12 milestone_col">															<div class="milestone text-centerx">																<div class="milestone_text">Search courses by category</div>															</div>															<form action="#" class="course_search_form search-cat-inner">																		<div class="course-search-div">																				<div class="dd">																						<div class="dd-a"><span>Full Qualification Courses</span> 													<div class="droparrow"><i class="fa fa-caret-down"></i></div>													</div>																						<input type="checkbox">																						<div class="dd-c">									  														<ul>																									<li><a href="<?php echo $url; ?>short-courses"><span>Short Courses</span></a></li>																																			<li><a href="<?php echo $url; ?>traffic-control"><span>Traffic Control Courses</span></a></li>																																			<li><a href="<?php echo $url; ?>construction-courses"><span>Construction Courses</span></a></li>																																			<li><a href="<?php echo $url; ?>hospitality"><span>Hospitality Courses</span></a></li>																																			<li><a href="<?php echo $url; ?>first-aid-courses"><span>First Aid Courses</span></a></li>																									<li><a href="<?php echo $url; ?>full-qualification-courses"><span>Full Qualification Courses</span></a></li>																									<li><a href="<?php echo $url; ?>government-funded-courses"><span>Government Funded Courses</span></a></li>																									<li><a href="<?php echo $url; ?>all-courses"><span>All Courses</span></a></li>									  														</ul>																						</div>																				</div>																		</div>																</form>													</div>						<!--<div class="col-lg-6 milestone_col">					<div class="milestone text-center">						<div class="milestone_icon"><img src="images/location.png" alt=""></div>						<div class="milestone_text">Course by</div>						<div class="milestone_heading">LOCATION</div>					</div>					<form action="#" class="course_search_form search-loc">						<div class="course-search-div">								<div class="dd">									<div class="dd-a"><span>Locations</span> <div class="droparrow"><i class="fa fa-caret-down"></i></div></div>									<input type="checkbox">									<div class="dd-c">									  <ul>										<li><a href="parramatta.php"><span>Parramatta</span></a></li>										<li><a href="liverpool.php"><span>Liverpool</span></a></li>										<li><a href="burwood.php"><span>Burwood</span></a></li>										<li><a href="penrith.php"><span>Penrith</span></a></li>										<li><a href="seven-hills.php"><span>Seven Hills</span></a></li>										<li><a href="phillip.php"><span>Phillip</span></a></li>										<li><a href="contact.php"><span>All Locations</span></a></li>									  </ul>									</div>								</div>							</div>					</form>				</div>-->			</div>
					...
					<div class="course" id="full-qualification">
									...
									<div class="course_body">
										<div class="course_header d-flex flex-row align-items-center justify-content-start">
											<div class="course_tag"><a href="#">Full qualification</a></div>
										</div>
