...
<html lang="en">
<head>
<title>Short Courses Sydney | Trans-Plant training</title>
<meta charset="utf-8">
...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Short Courses</div>
	...
	<div class="courses">
		<div class="container">
			<!-- Course Search -->						<!-- Course Search -->			<div class="row">				
	<div class="col-lg-12 milestone_col">					
										...
										<form action="#" class="course_search_form search-cat-inner">							
											<div class="course-search-div">								
												<div class="dd">									
													<div class="dd-a"><span>Short Courses</span> 
			...
			<div class="row courses_row short-courses-wrap">
				...
				<div class="col-lg-6 col-md-6">
					<div class="course" id="traffic-control">
									...
									<div class="course_body"><div class="course_title"><h1><a href="<?php echo $url; ?>traffic-control">Traffic Controller</a></h1></div>
									</div>
								</div>
				</div>
				...
				<div class="col-lg-6 col-md-6">
					<div class="course" id="hopitality">
									...
									<div class="course_title"><h1><a href="<?php echo $url; ?>hospitality">Hopitality</a></h1></div>
									</div>
								</div>
				</div>
				...
				<div class="col-lg-6 col-md-6">
					<div class="course" id="construction">
									...
									<div class="course_body">
										<div class="course_title"><h1><a href="<?php echo $url; ?>construction-courses">Construction</a></h1></div>
									</div>
								</div>
				</div>
				...
				<div class="col-lg-6 col-md-6">
					<div class="course" id="first-aid">
									...
									<div class="course_body">										
										<div class="course_title"><h1><a href="<?php echo $url; ?>first-aid-courses">First Aid Courses</a></h1></div>
