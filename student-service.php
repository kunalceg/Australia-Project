...
<html lang="en">
<head>
<title>Student Services Sydney | Trans-Plant training</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<div class="home breadcrumb-banner">
		...
		<div class="home_background parallax_background parallax-window hidden-xs" data-parallax="scroll" data-image-src="<?php echo $url; ?>images/student-service-desk.jpg" data-speed="0.8"></div>
		<div class="home_background parallax_background parallax-window hidden-xl hidden-lg hidden-sm hidden-md" data-parallax="scroll" data-image-src="<?php echo $url; ?>images/student-mob2.jpg" data-speed="0.8"></div>
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Student Services</div>
			...
			<div class="row about_row row-lg-eq-height">
				<div class="col-lg-12">
					<div class="about_content">
						<div class="about_title">Students Services</div>
						<div class="about_text">
							<div class="col-lg-4 col-xs-12 col-sm-6 col-md-6 pull-left">							<div class="button text-center"><a href="<?php echo $url; ?>images/pdf/Leaner-Handbook-V4.0-Feb-2022.pdf" target="_blank" data-icon="=">LEARNER HANDBOOK<div class="button_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></div></a></div>							</div>							<div class="col-lg-4 col-xs-12 col-sm-6 col-md-6 pull-left">							<div class="button text-center"><a href="<?php echo $url; ?>images/pdf/Short-Course-Refund-Policy.pdf" target="_blank" data-icon="=">SHORT COURSE REFUND POLICY<div class="button_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></div></a></div>							</div>
						</div>
					</div>
				</div>
			</div>
