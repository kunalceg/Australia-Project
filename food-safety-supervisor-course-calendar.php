...
<html lang="en">
<head>
<title>Food Safety Supervisor Course Calendar | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Food Safety Supervisor Course Calendar</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>	
									<li><a href="<?php echo $url; ?>all-courses">Courses</a></li> 
									<li><a href="<?php echo $url; ?>first-aid-course-calendar">Food Safety Supervisor Course</a></li> 
									<li>Food Safety Supervisor Course Calendar</li>	</ul>	
							</div>	
