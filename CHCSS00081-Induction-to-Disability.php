...
<html lang="en">
<head>
<title>CHCSS00081- Induction to Disability | Trans-Plant training</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<div class="home breadcrumb-banner">
		<div class="home_background parallax_background parallax-window hidden-xs" data-parallax="scroll" data-image-src="<?php echo $url; ?>images/CHCSS00081-desk.jpg" data-speed="0.8"></div>
		<div class="home_background parallax_background parallax-window hidden-xl hidden-lg hidden-sm hidden-md" data-parallax="scroll" data-image-src="<?php echo $url; ?>images/CHCSS00081-mob.jpg" data-speed="0.8"></div>
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Government Funded Course<br/>CHCSS00081- Induction to Disability</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>
									<li><a href="<?php echo $url; ?>all-courses">Courses</a></li>
									<li>CHCSS00081- Induction to Disability</li>
								</ul>
							</div>
						</div>
					</div>
...
<hr/>
				...
				<div class="col-lg-6">
				<div class="row">
					<img width="100%" height="auto" alt="" title="Traffic Control" src="<?php echo $url; ?>images/Induction-to-Disability.png">
				</div>
				</div>
				<div class="col-lg-6">
						...
						<div class="accordions">
							...
							<div class="accordion_container">
								...
								<div class="accordion_panel">
									<div>
										<p>This skill set reflects the skill requirements for supporting people with disability. It provides a set of skills to support the induction of new workers into a variety of roles supporting people with disability.</p>
									</div>
								</div>
							</div>
							...
							<div class="accordion_container">
								...
								<div class="accordion_panel">
									...
									<ul>
										...
										<li>CHCDIS007 Facilitate the empowerment of people with disability</li>
										<li>CHCCCS015 Provide individualised support</li>
