...
<html lang="en">
<head>
<title>Parramatta Training Facility Sydney | Trans-Plant training</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Parramatta Training Facility</div>
							<div class="breadcrumbs">
								<ul>
									<li><a href="<?php echo $url; ?>./">Home</a></li>
									<li><a href="<?php echo $url; ?>calendar">Calander</a></li>
									<li>Parramatta Training Facility</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6">
					<div class="about_content">
						...
						<div class="about_text">
							<p>Trans-Plant Training offers accredited <a herf="<?php echo $url; ?>traffic-controller-course">traffic control training</a> and <a href="<?php echo $url; ?>white-card">white card courses</a> from it’s training location in Parramatta, NSW. Parramatta is located just 24 KM west of the Sydney central business district on the banks of the Parramatta River.</p>
<p>
These courses offer students the ability to gain a SafeWork NSW Traffic Control Work Training Card which is commonly completed for employment within the traffic management industry or a White Card which is required for workers who want to carry out work on a construction site.</p>
				...
				<div class="col-lg-6">
					<div class="location_body text-center">
							<h2>Address</h2>
							<p style="text-align: center;">Unit 102, 30 Cowper St.<br>Parramata, NSW 2150</p>
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3314.754864458018!2d151.00578791480268!3d-33.81863858067005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12a363de4a82b9%3A0xe501da434337005!2sTrans-Plant%20Training%20-%20Parramatta!5e0!3m2!1sen!2sin!4v1658824517184!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						</div>
				</div>
			</div>
